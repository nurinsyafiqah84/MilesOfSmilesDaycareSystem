...
$querySearchEnrolment = "";
	...
	if($_POST['options'] == "enrolmentIDAZ"){
		...
		WHERE dependent.fullName LIKE '%".$search."%' OR username LIKE '%".$search."%' OR enrolment.enrolmentID = '".$search."' OR admissionMonth = '".$search."' OR admissionYear = '".$search."' OR status = '".$search."' OR enrolment.dateOfApplication LIKE '".$search."%' ORDER BY enrolment.enrolmentID ASC";
		...
		JOIN parent ON
		dependent.parentID = parent.username
		WHERE dependent.fullName LIKE '%".$search."%' OR username LIKE '%".$search."%' OR enrolment.enrolmentID = '".$search."' OR admissionMonth = '".$search."' OR admissionYear = '".$search."' OR status = '".$search."' OR enrolment.dateOfApplication LIKE '".$search."%' ORDER BY enrolment.enrolmentID DESC";
		...
		JOIN parent ON
		dependent.parentID = parent.username
		WHERE dependent.fullName LIKE '%".$search."%' OR username LIKE '%".$search."%' OR enrolment.enrolmentID = '".$search."' OR admissionMonth = '".$search."' OR admissionYear = '".$search."' OR status = '".$search."' OR enrolment.dateOfApplication LIKE '".$search."%' ORDER BY dependent.fullName ASC";
		...
		JOIN parent ON
		dependent.parentID = parent.username
		WHERE dependent.fullName LIKE '%".$search."%' OR username LIKE '%".$search."%' OR enrolment.enrolmentID = '".$search."' OR admissionMonth = '".$search."' OR admissionYear = '".$search."' OR status = '".$search."' OR enrolment.dateOfApplication LIKE '".$search."%' ORDER BY dependent.fullName DESC";
		...
		JOIN parent ON
		dependent.parentID = parent.username
		WHERE dependent.fullName LIKE '%".$search."%' OR username LIKE '%".$search."%' OR enrolment.enrolmentID = '".$search."' OR admissionMonth = '".$search."' OR admissionYear = '".$search."' OR status = '".$search."' OR enrolment.dateOfApplication LIKE '".$search."%' ORDER BY enrolment.status ASC";
		...
		JOIN parent ON
		dependent.parentID = parent.username
		WHERE dependent.fullName LIKE '%".$search."%' OR username LIKE '%".$search."%' OR enrolment.enrolmentID = '".$search."' OR admissionMonth = '".$search."' OR admissionYear = '".$search."' OR status = '".$search."' OR enrolment.dateOfApplication LIKE '".$search."%' ORDER BY enrolment.status DESC";
	}else{
		$querySearchEnrolment = "SELECT *, dependent.fullName AS dependentName FROM enrolment JOIN dependent 
		ON enrolment.dependentID = dependent.dependentID
		JOIN parent ON
